...
void Renderer::display() {
  ...
  shaderNodeB.render(meshB, shaderSettingsB.backgroundColor, windowWidth, windowHeight, false, false);
	...
	//	cv::Mat saveBufferMat(shaderSettingsA.height, shaderSettingsA.width, CV_32FC3);
...
//	glReadPixels(0,0,shaderSettingsA.width,shaderSettingsA.height,GL_BGR,GL_FLOAT,saveBufferMat.data);

//	std::stbi_flip_vertically_on_write(true);
//	stbi_write_png(filepath, width, height, nrChannels, buffer.data(), stride);
	...
	cout<<"flipped.depth():"<<flipped.depth()<<endl;
	cv::imwrite("saveBufferMat.png", flipped);
	cout<<"Image saved! And its width: "<< flipped.cols<<", its height:"<<flipped.rows<<endl;
